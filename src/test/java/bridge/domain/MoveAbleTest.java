...
public class MoveAbleTest {
    ...
    @ParameterizedTest
    void checkCorrectMovingTest(String input, MovingType bridgeType, MovingType moveAbleType, String status) {

        String result = MoveAble.getMoveBridgeFilter(input, bridgeType, moveAbleType);
